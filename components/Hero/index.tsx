...
import mainImage from "@/assets/woman-black-sweater.png";
            ...
            <div className="-mx-4 flex ">
              <div className=" px-4 md:w-4/6">
                ...
                <Link
                  ...
                  className="rounded-md bg-[#f76112] py-4 px-8 text-base font-semibold text-white duration-300 ease-in-out"
                >
                  Click to start filling tax
                </Link>
              </div>
              <div className="md:w-2/6 flex justify-center items-center">
              <div className="w-[345px] h-[345px] hidden lg:block bg-primary rounded-full"></div>
                <Image
                  src={mainImage}
                  alt="logo"
                  width={1000}
                  height={1000}
                  className="absolute hidden lg:block bottom-0 right-[17rem] w-[429px]"
                />
              </div>
            </div>
          </div>
